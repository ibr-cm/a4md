...
namespace artery {
    ...
    void MisbehaviorDetectionService::initialize() {
        ...
        if(uniform(0,1) > F2MDParameters::detectionParameters.generateLevel4AndBelowProbability){
            mCheckableDetectionLevels[detectionLevels::Level4] = false;
        }
        if(uniform(0,1) > F2MDParameters::detectionParameters.generateLevel3AndBelowProbability){
            mCheckableDetectionLevels[detectionLevels::Level3] = false;
        }
        if(uniform(0,1) > F2MDParameters::detectionParameters.generateLevel2AndBelowProbability){
    ...
    void MisbehaviorDetectionService::initializeParameters() {
        ...
        F2MDParameters::detectionParameters.generateLevel4AndBelowProbability = par("generateLevel4AndBelowProbability");
        F2MDParameters::detectionParameters.generateLevel3AndBelowProbability = par("generateLevel3AndBelowProbability");
        F2MDParameters::detectionParameters.generateLevel2AndBelowProbability = par("generateLevel2AndBelowProbability");
